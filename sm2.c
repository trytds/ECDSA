...
//}
//
//digital_sign signSM2(miracl* pm, big e_b)
//{
//	big k = mirvar(0);
//	irand(time(NULL));
//	bigrand(g_n, k);
...
//	ecurve_mult(k, g_G, kk); //A4 计算椭圆曲线点(x1,y1)=[k]G
//
...
//	pm->IOBASE = 16;
//
//	add(e_b, kk->X, a.r); //e_b是Hash值  a.r=e_b+kk->X
//
//	big tmp_rk = mirvar(0); 
//	add(a.r, k, tmp_rk);
//	divide(a.r, g_n, g_n);
...
//}
//
//int vertifySM2(digital_sign a, miracl* pm, big e_b)
//{
